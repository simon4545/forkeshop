    ...
    window.Framework7 = function (params) {
        ...
        ************   Navigation / Router   ************
        ...
        app.router.back = function (view, options) {
            /**************20150722 add by yczhu***********************************/
            if((typeof options).toLowerCase() === "object"){
                if((typeof options.backFlag).toLowerCase() === "undefined"){
                    options.backFlag = true;
                }
            }
        ...
        ************   Pull To Refresh   ************
        ...
        app.initPullToRefresh = function (pageContainer) {
            //TODO:为了增加一个然并卵的功能--zzsun 2015-11-13
            var ___no_translate = false;
            if($(pageContainer).hasClass('no-translate-flag')){
                ___no_translate = true;
            }
            ...
            function handleTouchMove(e) {
                ...
                if (touchesDiff > 0 && scrollTop <= 0 || scrollTop < 0) {
                    ...
                    if (useTranslate) {
                        ...
                        //TODO:这里是下拉刷新时单独为场景页首图做调整-然并卵--zzsun 2015-11-13
                        pullToChange && pullToChange( translate );
                    }
                    else {
                    }
            ...
            function handleClicks(e) {
                ...
                if (validUrl || clicked.hasClass('back') || template) {
                    ...
                    if (clicked.hasClass('back')){
                        ...
                        if(view.history[view.history.length - 2].indexOf('page/') !== 0){
                            options.url = "page/index.html";
        ...
        s.effects = {
            ...
            cube: {
                setTranslate: function () {
                    ...
                    //TODO:zzsun wrapper change-size
                    var zFactor;
                    if(s.params.cube.allSize){
                        zFactor = 0;
                    }else{
                        zFactor = (s.isSafari || s.isUiWebView) ? (-s.size / 2) : 0;
                    }
